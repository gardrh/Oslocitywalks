...
const TOUR_GREATHITS = {
  ...
  es: [
    ...
    },
    {
      ...
      answers: ["10", "ten", "ti", "dix", "zehn", "diez"],
      hints: ["Mira con atenci\u00f3n lo que hace con sus manos.", "Mira la placa a sus pies"]
    },
    {
      chapter: "Escena 5",
      text: "El Grand Hotel y su contiguo Grand Caf\u00e9 han sido durante mucho tiempo una instituci\u00f3n importante en Oslo. Aqu\u00ed ven\u00edan artistas, escritores y personalidades notables como Edvard Munch, Roald Amundsen, Gustav Vigeland y Fridtjof Nansen a comer, beber y socializar.\n\nHenrik Ibsen, uno de los escritores noruegos m\u00e1s famosos, supuestamente pasaba cada d\u00eda al mediod\u00eda para su almuerzo habitual: un chupito, un vaso de cerveza alemana y una pila de peri\u00f3dicos extranjeros.\n\nContin\u00faa por <b>Karl Johans gate</b> hacia el <b>Nationaltheatret</b> (el Teatro Nacional). Alrededor del teatro encontrar\u00e1s varias estatuas. Una de ellas tiene lo que podr\u00eda llamarse una barba inconfundible.\n\n\u00bfQui\u00e9n es?",
      answers: ["henrik ibsen", "ibsen"],
      hints: ["Ya has o\u00eddo hablar de \u00e9l en esta ruta.", "Le gustaba la cerveza y los peri\u00f3dicos.", "Est\u00e1 en el lado izquierdo del teatro."]
    },
    {
      chapter: "Escena 6",
