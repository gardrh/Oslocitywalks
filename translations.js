...
const t = {
  ...
  ui: {
    en: {
      ...
      tour3Title:     'Short Tour of Central-Western Oslo',
      tour3Desc:      'This tour starts at Nationaltheatret and takes you around the central-western part of the city and along the waterfront. About 4–5 km, roughly one hour.',
    ...
    no: {
      ...
      tour3Title:     'Korttur i sentrum-vest',
      tour3Desc:      'Denne turen starter ved Nationaltheatret og tar deg rundt i den sentrum-vestlige delen av byen og langs sjøen. Ca. 4–5 km, omtrent én time.',
    ...
    es: {
      ...
      tour3Title:     'Ruta corta por el centro-oeste de Oslo',
      tour3Desc:      'Esta ruta comienza en Nationaltheatret y te lleva por la zona centro-occidental de la ciudad y a lo largo de la orilla del mar. Unos 4–5 km, aproximadamente una hora.',
    ...
    de: {
      ...
      tour3Title:     'Kurztour durch Zentrum-West Oslo',
      tour3Desc:      'Diese Tour beginnt am Nationaltheatret und führt dich durch den zentral-westlichen Teil der Stadt und entlang der Uferpromenade. Ca. 4–5 km, ungefähr eine Stunde.',
