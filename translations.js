...
const t = {
  ...
  ui: {
    ...
    no: {
      ...
      aboutP5:       'Los! er utviklet av <strong>Gard Ringen Høibjerg</strong>, og teamet drives av ønsket om å hjelpe bеsøkende med å oppdage de mer interessante krokene av byen. Har du tilbakemeldinger, oppdager en feil, eller vil komme i kontakt — vi hører gjerne fra deg.',
    ...
    es: {
      ...
      tour2Desc:       'Esta ruta comienza al final de Karl Johan y te lleva por la historia de cómo Oslo y Noruega se convirtieron en lo que son hoy — a través del conflicto, la cultura y la independencia. Aprox. 4–5 km, alrededor de 1–2 horas. Inicio: Estación de Oslo — Final: Cerca de la Ópera',
    ...
    de: {
      ...
      tour2Desc:       'Diese Tour beginnt am unteren Ende der Karl Johan und führt dich durch die Geschichte, wie Oslo und Norwegen zu dem wurden, was sie heute sind — durch Konflikt, Kultur und Unabhängigkeit. Ca. 4–5 km, etwa 1–2 Stunden. Start: Osloer Hauptbahnhof — Ende: In der Nähe des Opernhauses',
    ...
    fr: {
      ...
      tour2Desc:       'Cette visite commence au bas de Karl Johan et vous guide à travers l’histoire d’Oslo et de la Norvège — à travers les conflits, la culture et l’indépendance. Environ 4–5 km, 1–2 heures environ. Départ : Gare d’Oslo — Arrivée : Près de l’Opéra',
