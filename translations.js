...
const t = {
  ...
  ui: {
    en: {
      ...
      tour1Desc:       'Walk Karl Johans gate from the railway station to the Royal Palace, solving tasks and getting to know the people and places along the city’s most famous street. Start: Oslo railway station — End: The Royal Palace',
      tour2Title:     'Oslo and Norway’s Becoming',
      tour2Desc:       'This tour starts at the bottom of Karl Johan and takes you through the history of how Oslo and Norway became what they are today — through conflict, culture and independence. Start: Oslo railway station — End: Close to the Opera House',
      tour3Title:     'Akerselva & Oslo’s Industrial Past',
      tour3Desc:      'The tour starts in Nydalen — take the T-bane and find the nearest river: Akerselva! Walk towards the city centre, solving tasks and discovering Oslo’s industrial history.',
      tour4Title:     '',
      tour4Desc:      '',
    ...
    no: {
      ...
      tour1Desc:       'Gå Karl Johans gate fra jernbanestasjonen til Slottet, løs oppgaver og bli kjent med menneskene og stedene langs byens mest kjente gate. Start: Oslo sentralstasjon — Slutt: Slottet',
      tour2Title:     'Oslo og Norges tilblivelse',
      tour2Desc:       'Denne turen starter nederst på Karl Johan og tar deg gjennom historien om hvordan Oslo og Norge ble det de er i dag — gjennom konflikt, kultur og selvstendighet. Start: Oslo sentralstasjon — Slutt: Nær Operahuset',
      tour3Title:     'Akerselva og Oslos industrifortid',
      tour3Desc:      'Turen starter i Nydalen — ta T-banen og finn nærmeste elv: Akerselva! Gå mot sentrum og løs oppgaver mens du oppdager Oslos industrihistorie.',
      tour4Title:     '',
      tour4Desc:      '',
    ...
    es: {
      ...
      tour1Desc:       'Recorre Karl Johans gate desde la estación de tren hasta el Palacio Real, resolviendo tareas y conociendo a las personas y lugares a lo largo de la calle más famosa de la ciudad. Inicio: Estación de Oslo — Final: El Palacio Real',
      tour2Title:     'Oslo y el nacimiento de Noruega',
      tour2Desc:       'Esta ruta comienza al final de Karl Johan y te lleva por la historia de cómo Oslo y Noruega se convirtieron en lo que son hoy — a través del conflicto, la cultura y la independencia. Inicio: Estación de Oslo — Final: Cerca de la Ópera',
      tour3Title:     'Akerselva y el pasado industrial de Oslo',
      tour3Desc:      'La ruta comienza en Nydalen — toma el T-bane y encuentra el río más cercano: Akerselva! Camina hacia el centro resolviendo tareas y descubriendo la historia industrial de Oslo.',
      tour4Title:     '',
      tour4Desc:      '',
    ...
    de: {
      ...
      tour1Desc:       'Geh die Karl Johans gate vom Bahnhof zum Königlichen Schloss, löse Aufgaben und lerne die Menschen und Orte entlang der berühmtesten Straße der Stadt kennen. Start: Osloer Hauptbahnhof — Ende: Das Königliche Schloss',
      tour2Title:     'Oslo und Norwegens Werden',
      tour2Desc:       'Diese Tour beginnt am unteren Ende der Karl Johan und führt dich durch die Geschichte, wie Oslo und Norwegen zu dem wurden, was sie heute sind — durch Konflikt, Kultur und Unabhängigkeit. Start: Osloer Hauptbahnhof — Ende: In der Nähe des Opernhauses',
      tour3Title:     'Akerselva und Oslos Industrievergangenheit',
      tour3Desc:      'Die Tour beginnt in Nydalen — nimm die T-bane und finde den nächsten Fluss: Akerselva! Geh Richtung Innenstadt und löse Aufgaben, während du Oslos Industriegeschichte entdeckst.',
      tour4Title:     '',
      tour4Desc:      '',
    ...
    fr: {
      ...
      tour1Desc:       'Parcourez la Karl Johans gate de la gare au Palais Royal, en résolvant des énigmes et en découvrant les personnes et les lieux le long de la rue la plus célèbre de la ville. Départ : Gare d’Oslo — Arrivée : Le Palais Royal',
      tour2Title:     'Oslo et la naissance de la Norvège',
      tour2Desc:       'Cette visite commence au bas de Karl Johan et vous guide à travers l’histoire d’Oslo et de la Norvège — à travers les conflits, la culture et l’indépendance. Départ : Gare d’Oslo — Arrivée : Près de l’Opéra',
      tour3Title:     'L’Akerselva et le passé industriel d’Oslo',
      tour3Desc:      'La visite commence à Nydalen — prenez le T-bane et trouvez la rivière la plus proche : l’Akerselva ! Marchez vers le centre-ville en résolvant des énigmes et en découvrant le passé industriel d’Oslo.',
      tour4Title:     '',
      tour4Desc:      '',
