...
const t = {
  ...
  ui: {
    ...
    no: {
      ...
      tour1Desc:       'Gå Karl Johans gate fra jernbanestasjonen til Slottet, løs oppgaver og bli kjent med menneskene og stedene langs byens mest kjente gate. Ca. 2–3 km, omtrent én time. Start: Oslo sentralstasjon — Slutt: Slottet',
    ...
    es: {
      ...
      tour1Desc:       'Recorre Karl Johans gate desde la estación de tren hasta el Palacio Real, resolviendo tareas y conociendo a las personas y lugares a lo largo de la calle más famosa de la ciudad. Aprox. 2–3 km, alrededor de una hora. Inicio: Estación de Oslo — Final: El Palacio Real',
    ...
    de: {
      ...
      tour1Desc:       'Geh die Karl Johans gate vom Bahnhof zum Königlichen Schloss, löse Aufgaben und lerne die Menschen und Orte entlang der berühmtesten Straße der Stadt kennen. Ca. 2–3 km, etwa eine Stunde. Start: Osloer Hauptbahnhof — Ende: Das Königliche Schloss',
    ...
    fr: {
      ...
      tour1Desc:       'Parcourez la Karl Johans gate de la gare au Palais Royal, en résolvant des énigmes et en découvrant les personnes et les lieux le long de la rue la plus célèbre de la ville. Environ 2–3 km, une heure environ. Départ : Gare d’Oslo — Arrivée : Le Palais Royal',
