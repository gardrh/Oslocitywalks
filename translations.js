...
const t = {
  ...
  ui: {
    en: {
      ...
      tour1Title:       'The Search for Karl Johan',
      tour1Desc:       'This short interactive tour takes you through the heart of Oslo along Karl Johans gate — follow the clues, explore the city, and uncover stories about famous Norwegians, political struggles, writers, artists and the history of Norway itself. Start: Oslo railway station — End: The Royal Palace',
    ...
    es: {
      ...
      tour1Title:       'La búsqueda de Karl Johan',
      tour1Desc:       'Esta corta ruta interactiva te lleva por el corazón de Oslo a lo largo de Karl Johans gate — sigue las pistas, explora la ciudad y descubre historias sobre noruegos famosos, luchas políticas, escritores, artistas y la historia de Noruega. Inicio: Estación de Oslo — Final: El Palacio Real',
      tour2Title:     'Oslo y el nacimiento de Noruega',
      tour2Desc:       'Esta ruta comienza al final de Karl Johan y te lleva por la historia de cómo Oslo y Noruega se convirtieron en lo que son hoy — a través del conflicto, la cultura y la independencia.s. Inicio: Estación de Oslo — Final: Cerca de la Ópera',
    ...
    de: {
      ...
      tour1Title:       'Die Suche nach Karl Johan',
      tour1Desc:       'Diese kurze, interaktive Tour führt dich durch das Herz Oslos entlang der Karl Johans gate — folge den Hinweisen, erkundige dich in der Stadt und entdecke Geschichten über berühmte Norweger, politische Kämpfe, Schriftsteller, Künstler und die Geschichte Norwegens. Start: Osloer Hauptbahnhof — Ende: Das Königliche Schloss',
    ...
    fr: {
      ...
      tour1Title:       'La quête de Karl Johan',
      tour1Desc:       'Cette courte visite interactive vous entraîne au cœur d’Oslo le long de la Karl Johans gate — suivez les indices, explorez la ville et découvrez des histoires sur des Norvégiens célèbres, des luttes politiques, des écrivains, des artistes et l’histoire de la Norvège. Départ : Gare d’Oslo — Arrivée : Le Palais Royal',
